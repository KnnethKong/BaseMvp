...
public class JZCLayout extends ViewGroup {
    ...
    public JZCLayout(Context context) {
        this(context, null);
    }

    public JZCLayout(Context context, AttributeSet attrs) {
        super(context, attrs);

        // 获取自定义属性
//        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.FlowLayout);
        horizontal_space = 10;//array.getDimension(R.styleable.FlowLayout_width_space,0);
        vertical_space = 10;// array.getDimension(R.styleable.FlowLayout_height_space,0);
//        array.recycle();
