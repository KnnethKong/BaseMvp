...
public class BaseKeyBoard {
    ...
    public void init(AppCompatActivity activity, int layoutResId) {
    ...
    public void init(AppCompatActivity activity, int layoutResId, boolean mIfRandom) {
        this.mActivity = activity;
        this.layoutResId = layoutResId;
    ...
    private KeyboardView.OnKeyboardActionListener mOnKeyboardActionListener = new KeyboardView.OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            switch (primaryCode) {
                ...
                case -264://除
                    Toast.makeText(mActivity, "chu", Toast.LENGTH_SHORT).show();
                    break;
                case -265://乘
                    Toast.makeText(mActivity, "cheng", Toast.LENGTH_SHORT).show();

                    break;
                case -266://减
                    Toast.makeText(mActivity, "jian", Toast.LENGTH_SHORT).show();

                    break;
                case -267://加
                    Toast.makeText(mActivity, "jia", Toast.LENGTH_SHORT).show();
...
//            }
    ...
    public static void hideSystemSofeKeyboard(Context context, EditText editText) {
        ...
        // 如果软键盘已经显示，则隐藏
        @SuppressLint("WrongConstant") InputMethodManager imm = (InputMethodManager) context.getSystemService(Context.INPUT_METHOD_SERVICE);
