...
import com.base.draw.MyScrollView;
import com.base.mvp.R;

public class WelcomePagerTransformer implements PageTransformer, OnPageChangeListener {
	...
	public void transformPage(View view, float position) {
		...
		int bg1_green = view.getContext().getResources().getColor(R.color.green);
		int bg2_blue = view.getContext().getResources().getColor(R.color.blue);
