...
//        setSupportActionBar((Toolbar) findViewByIdById(R.id.toolbar));
    ...
    private String key="0xsdo311930zkowkocRawPpksg8Wt2WzwnHGzYB53sH5JE9R2zAxLwPgQwuwLdruq1x8u6290686693952417485234714928592934002766308253878680476708427961158423933622745007543572514881890676963632359664554864451707059199539909713005045398869965";
    ...
    private void createEnglishQRCode() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(Void... params) {
                return QRCodeEncoder.syncEncodeQRCode(key, BGAQRCodeUtil.dp2px(TestGeneratectivity.this, 150), Color.parseColor("#ff0000"));
            }
